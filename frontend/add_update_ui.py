...
def add_update_tab():
    ...
    categories = ["Rent", "Food", "Entertainment", "Shopping", "Toll", "Fuel", "Other"]
    ...
    with st.form(key = "expense_form"):
        ...
        for i in range(10):
            ...
            with col1:
                amount_input = st.number_input(label = "Amount", min_value = 0.00, step = 1.00, value = amount, key=f"amount_{i}", label_visibility = "collapsed")
        ...
        if submit_button:
            filtered_expenses = [expense for expense in expenses if expense['amount'] > 0.00]
